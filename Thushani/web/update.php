...
if(isset($_POST['work_UPDATE'])){
    ...
    $updateBasicQuery = "UPDATE user SET user_name='$name',email='$email',phone_number='$phone' WHERE reg_id=$id";
...
if(isset($_POST['com_update'])){
    ...
    $updateDescriptionQuery = "UPDATE com_profile SET description = '$description',address='$address' WHERE reg_id = $id";
    $resultdescription=mysqli_query($con, $updateDescriptionQuery);
