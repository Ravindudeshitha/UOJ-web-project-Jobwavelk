...
<?php
    ...
    include ('sidebar.php');
        ...
        $com_image = "uploads/$row2[com_image]";

        
        if(isset($_POST['com_update']) && isset($_FILES['update_image'])){
            $user_name = $_POST['user_name'];
            $email = $_POST['email'];
            $phone = $_POST['phone_number'];
            $address = $_POST['address'];
            $description = $_POST['com_description'];
            ...
            if(empty($_FILES['update_image']['name'])){
                $update_com_image = $row2['com_image'];
            }
            else{
                $update_com_image = $new_name;
            }

            $update1 = "UPDATE com_profile SET com_description = '$description', address = '$address', com_image = '$update_com_image' WHERE reg_id = '$reg_id'";
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form_content">
                            <div class="field">
                                ...
                                <input type="text" name="user_name" value="<?php echo $user_name ?>" placeholder="" required>
                            </div>
                            ...
                            <div class="field">
                                ...
                                <textarea name="com_description"required><?php echo $description ?></textarea>
                            </div>
